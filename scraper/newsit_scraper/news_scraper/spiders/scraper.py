...
class Newspider(scrapy.Spider):
    ...
    def start_requests(self):
        # Connect to MongoDB
        self.client = MongoClient('mongodb://localhost:27017/', socketTimeoutMS=10000, connectTimeoutMS=10000)
    ...
    def parse_articles(self, response):
        ...
        date_upper = datetime.strptime("2024-10-27", "%Y-%m-%d")
        ...
        for article in articles.css(site_config['article']):
            ...
            if article_date >= date_limit and article_date <= date_upper:
